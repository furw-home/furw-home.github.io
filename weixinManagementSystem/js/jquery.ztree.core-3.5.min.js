	...
	var G, H, I, J, K, L, r = {},
		...
		h = {
			...
			removeSelectedNode: function(b, a) {
				for (var c = h.getRoot(b), d = 0, f = c.curSelectedList.length; d < f; d++)
					if (a === c.curSelectedList[d] || !h.getNodeCache(b,
	...
	var j = {
		...
		i = {
				...
				for (f = d.length - 1; f >= 0; f--)
					if (g = d[f], a === g || !a && (!c || c !== g))
						if (k(g, e.id.A, b).removeClass(e.node.CURSELECTED), a) {
							...
							break
						} else d.splice(f, 1), b.treeObj.trigger(e.event.UNSELECTED, [m, b.treeId, g])
			},
			...
			makeNodeIcoStyle: function(b, a) {
				...
				if (!a.isAjaxing) {
					var d = a.isParent && a.iconOpen &&
						a.iconClose ? a.open ? a.iconOpen : a.iconClose : a[b.data.key.icon];
			...
			makeNodeLineClass: function(b, a) {
				...
				a.isParent ? c.push(a.open ? e.folder.OPEN :
				...
				if (h.getNodeCache(b, a.tId)) {
					...
					if (!b.data.keep.parent && g == 0) f.isParent = !1, f.open = !1, g = k(f, e.id.UL, b), l = k(f, e.id.SWITCH, b), j = k(f, e.id.ICON, b), i.replaceSwitchClass(f, l, e.folder.DOCU), i.replaceIcoClass(f, j, e.folder.DOCU), g.css("display", "none");
						...
						var o = f[d][g - 1],
							...
							l = k(o, e.id.SWITCH, b);
						j = k(o, e.id.ICON, b);
						f == c ? f[d].length == 1 ? i.replaceSwitchClass(o, l, e.line.ROOT) : (c = k(f[d][0], e.id.SWITCH, b), i.replaceSwitchClass(f[d][0],
							c, e.line.ROOTS), i.replaceSwitchClass(o, l, e.line.BOTTOM)) : i.replaceSwitchClass(o, l, e.line.BOTTOM);
